...
<AmazonEnvelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="amzn-envelope.xsd">
    <Header>
        ...
        <MerchantIdentifier>A2GYSPAJ7WDF11</MerchantIdentifier>
    </Header>
    ...
    <Message>
        ...
        <Product>
            ...
            <StandardProductID>
                <Type>UPC</Type>
                <Value>02012014</Value>
            </StandardProductID>
            <ProductTaxCode>A_GEN_NOTAX</ProductTaxCode>
            <DescriptionData>
                <Title>Mesmerizing Cz Stones Encrusted Pendant Set by Voylla</Title>
                <Brand>Voylla</Brand>
                <Description>Make a style statement with this mesmerizing gold plated pendant set. Embellished with glittering cz stones this set is a definite head-turner.</Description>
                <BulletPoint>Example Bullet Point 1</BulletPoint>
                <BulletPoint>Example Bullet Point 2</BulletPoint>
                <Manufacturer>Aadhya</Manufacturer>
