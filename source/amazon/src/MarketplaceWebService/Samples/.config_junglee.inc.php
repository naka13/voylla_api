<?php
    ...
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIJVURTGULXZMLJ2A');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'VoyllaTestJunglee');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A3E0L0OHCA87MY');
